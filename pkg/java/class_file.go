...
func (this *ClassReader) readAttribute() AttributeInfo {
	...
	// log.Printf("read attribute: %s", attributeName)
	...
	default:
		// log.Printf("No reader for attribute: %s, skip", attributeName)
...
func (this *ClassFile) Name() string {
...
func (this *ClassFile) IsAccessFlagSet(flag uint16) bool {
	return this.accessFlags&flag != 0
}

func (this *ClassFile) IsPublic() bool {
	return this.IsAccessFlagSet(JVM_ACC_PUBLIC)
}

func (this *ClassFile) IsSynthetic() bool {
	return this.IsAccessFlagSet(JVM_ACC_SYNTHETIC)
}

func (this *ClassFile) IsPrivate() bool {
