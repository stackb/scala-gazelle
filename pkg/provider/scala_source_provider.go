...
func NewScalaSourceProvider(progress progressFunc) *ScalaSourceProvider {
...
// ScalaSourceProvider is provider for scala source files. If -scala_source_index_in
...
func (r *ScalaSourceProvider) putKnownImport(rule *sppb.Rule, from label.Label, imp string, impType sppb.ImportType) {
