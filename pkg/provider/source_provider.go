...
func (r *SourceProvider) CheckFlags(flags *flag.FlagSet, c *config.Config, importRegistry resolver.KnownImportRegistry) error {
...
func (r *SourceProvider) putKnownImport(rule *sppb.Rule, from label.Label, imp string, impType sppb.ImportType) {
