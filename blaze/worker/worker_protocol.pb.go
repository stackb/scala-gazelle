...
const file_blaze_worker_worker_protocol_proto_rawDesc = "" +
	"\n" +
	"\"blaze/worker/worker_protocol.proto\x12\fblaze.worker\"3\n" +
	"\x05Input\x12\x12\n" +
	...
	"\rwas_cancelled\x18\x04 \x01(\bR\fwasCancelledBt\n" +
	"$com.google.devtools.build.lib.workerZLgithub.com/stackb/scala-gazelle/blaze/worker/worker_protocol;worker_protocolb\x06proto3"

var (
	file_blaze_worker_worker_protocol_proto_rawDescOnce sync.Once
	file_blaze_worker_worker_protocol_proto_rawDescData []byte
)

func file_blaze_worker_worker_protocol_proto_rawDescGZIP() []byte {
	file_blaze_worker_worker_protocol_proto_rawDescOnce.Do(func() {
		file_blaze_worker_worker_protocol_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_blaze_worker_worker_protocol_proto_rawDesc), len(file_blaze_worker_worker_protocol_proto_rawDesc)))
	})
...
var file_blaze_worker_worker_protocol_proto_goTypes = []any{
...
func file_blaze_worker_worker_protocol_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_blaze_worker_worker_protocol_proto_rawDesc), len(file_blaze_worker_worker_protocol_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
